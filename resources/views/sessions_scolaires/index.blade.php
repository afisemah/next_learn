<!-- resources/views/sessions_scolaires/index.blade.php -->
    ...
    <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form model="specialitymodel" accept-charset="UTF-8" class="form" style="margin-bottom: 0;" action="{{ route('sessions-scolaires.store') }}" method="POST">
                    @csrf
                                    ...
                                    <table id="table" class="data-table-column-filter table table-bordered table-striped dataTable" style="margin-bottom: 0px; width: 1095px;" role="grid" aria-describedby="table_info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <form action="{{ route('sessions-scolaires.destroy', $session->id) }}" method="POST">
                                                        <a href="{{ route('sessions-scolaires.edit', $session->id) }}">
